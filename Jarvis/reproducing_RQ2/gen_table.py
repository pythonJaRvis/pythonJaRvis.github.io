...
cur = [
    ...
    ''.center(int1+2), 'E.A.(1).'.center(int1*2), 'D.A.(1).'.center(int1*2), 'E.A.(m)'.center(int1*2), 'D.A.(m)'.center(int1*2),'D.W.(1)'.center(int1*2), 'D.W.(2)'.center(int1*2), 'E.A.'.center(int1*2), 'D.A.'.center(int1*2), 'D.W.'.center(int1*2),
