...
def main():
    ...
    parser.add_argument(
        "--decy",
        action="store_true",
        help="whether analyze the dependencies",
        default=False
    )
    parser.add_argument(
        "--precision",
    ...
    parser.add_argument(
        "--moduleEntry",
        nargs="*",
        help="Entry functions to be processed",
        default=None
    )
    parser.add_argument(
        '--operation',
    ...
    cg = CallGraphGenerator(args.module, args.package,args.operation, decy=args.decy,precision=args.precision, moduleEntry=args.moduleEntry)
    cg.analyze()
